return {
    ...
    PLACES = {
        ...
        SR = {
            ...
            DATASTORE = 'SaveData',
            MAP_NAMES = {
                Candy = 'Sweet Speedway',
                Cowboy = 'Sunset Oasis',
                Dream = 'Lucid Lane',
                FloodedCity = 'Flooded City',
                RollBall = 'Marble Mania',
                Classic = 'Retro Raceway',
                Jungle = 'Jungle Underpass',
                Bomb = 'Magma Bomb Blitz',
                Snow = 'Winter Wonderland',
                City = 'Midnight Rush',
                SlimeFactory = 'Slime Factory',
                Bedroom = 'Bedroom',
                Skyline = 'Sky-High Ropeway',
                WaterWalk = 'Abandoned Lab',
                Water = 'Underwater Highway',
                Surf = 'Surfer\'s Paradise',
                Space = 'Space Station',
                Sodacan = 'Sodacan Canyon'
            }
        },
